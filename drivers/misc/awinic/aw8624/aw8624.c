...
static DEVICE_ATTR(cont_num_brk, S_IWUSR | S_IRUGO,
		aw8624_cont_num_brk_show, aw8624_cont_num_brk_store);
static DEVICE_ATTR(cont_zc_thr, S_IWUSR | S_IRUGO,
...
static DEVICE_ATTR(haptic_audio, S_IWUSR | S_IRUGO,
...
static DEVICE_ATTR(trig_boost, S_IWUSR | S_IRUGO,
